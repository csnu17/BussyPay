      ...
      , parseDate:
          function (date, format, language) {
              ...
              if (smartThai(language) && !((date instanceof Date) || /^[-+].*/.test(date))) {
                  ...
                  var formats = this.parseFormat(format) || format; //format; //this.parseFormat(format);
                  var parts = date && date.match(this.nonpunctuation) || [];

                  console.log([parts.length, formats.parts.length])
          ...
          function (date, format, language) {
              ...
              if (dspThaiYear(language)) {
                  ...
                  var val = {
                      ...
                      yyyy: (thai.adj + date.getUTCFullYear())
                  };
